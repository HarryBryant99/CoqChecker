...
let test_resolve_two_unitres () =
  ...
  let clause1 = Consclause (Pos (String (Ascii (True, False, True, False, True, False, True, False), EmptyString)), Nilclause) in
  let clause2 = Consclause (Neg (String (Ascii (False, False, True, False, True, False, True, False), EmptyString)), Nilclause) in
