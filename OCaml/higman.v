...
#[export] Hint Constructors emb.
#[export] Hint Constructors L.
#[export] Hint Constructors good.
#[export] Hint Constructors R.
#[export] Hint Constructors T. 
#[export] Hint Constructors bar.
#[export] Hint Extern 5 (?X1 <> ?X2) => intro; discriminate.

Theorem prop1 : forall ws : list word, bar (nil :: ws).
auto.
Defined.
#[export] Hint Resolve prop1.
...
Defined.
#[export] Hint Resolve prop3.

Theorem higman : bar nil.
apply bar2.
simple induction w; eauto.
Defined.
#[export] Hint Resolve higman.
...
#[export] Hint Constructors is_prefix.
...
eauto.
Defined.
#[export] Hint Resolve good_prefix_lemma.
...
Extraction "C:\Users\z004u5bh\Documents\Coq\OCaml/higman.ml" good_prefix.