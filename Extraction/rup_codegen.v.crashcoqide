...
(*CodeGen InductiveType list => "list".
CodeGen InductiveMatch list => "sw_list"
  | nil => "default"
  | cons => "case cons_tag" "cons_get_member_0" "cons_get_member_1".
*)
...
CodeGen Gen clause loop rup app_unique app already.