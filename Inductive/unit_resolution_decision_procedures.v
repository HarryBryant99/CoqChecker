...
Fixpoint memlc (l:literal) (c:clause) : bool :=
    match c with
      | nil => false
      | b :: m => if literal_eq_dec l b then true else memlc l m
    end.
...
Extraction "C:\Users\z004u5bh\Documents\Coq\OCaml\URes\ur_dp.ml" compute_subsumption.
...
Definition models_clause (m : literal -> Prop) (c : clause) : Prop :=
  model_property m -> exists l: literal, memlc l c = true /\ m l.
...
Lemma subset_clause_prop : forall c1:clause,
  ...
  (exists l:literal , memlc l c1 = true /\ m l) -> 
  forall c2:clause, subset c1 c2 = true -> exists l2:literal, memlc l2 c2 = true /\ m l2.
Proof.
